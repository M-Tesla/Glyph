...
--[[
  then, we'll add a new syntax to the syntax module, Glyph matches Lua patterns
...
syntax.add {
  ...
  patterns = {
    --[[
      ...
      See data/plugins/language_html.lua for a real-world example.

      ["type"] field:
      Set the style that should be used, this is defined on the "style" file from
      the Glyph source, at "data/core/style.lua".
    ]]
    {
      pattern = {"##%[=*%[", "%]=*%]"},
      syntax = ".lua",
